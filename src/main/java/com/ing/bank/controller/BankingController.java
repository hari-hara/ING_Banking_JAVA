...
public class BankingController {
	...
	public UserSummary userSummaryr(@PathVariable("userName") String userName) {
		return bankingService.getUserSummary(userName);

	}

	/*
	 * @PostMapping("/transaction") public void postTransaction(@Valid @RequestBody
	 * UserTransaction us) { bankingService.saveTransaction(us); }
	 */
	...
	public LoginResponse createCustomer(@Valid @RequestBody BankUser bankUser) {
		...
		// {"message" : "User Created successfully/ unable to create user", "accountNo"
		// : "1234" , "userName" : "xyz"}
